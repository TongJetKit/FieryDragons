...
public class SpeedDragonCard extends DragonCard {
    /**
     ...
     */
    public SpeedDragonCard(String revealImageURL, Symbol cardSymbol, int creatureCount, CardType type) {
    ...
    public Movement flipCard(Player activePlayer, FieryDragonsGameBoard gameBoard) {
        ...
        if (activePlayer.getMoveSpeed() < 1) {
            activePlayer.setMoveSpeed(1);
        } else {
